 ...
 * @phpstan-type SessionData array{sessionize_id: string, title: string, description: ?string, room_sessionize_id: ?string, starts_at: ?CarbonImmutable, ends_at: ?CarbonImmutable, status: ?string, is_confirmed: bool, is_service_session: bool, is_plenum_session: bool, categories: array<mixed>, speaker_ids: list<string>}
 */
